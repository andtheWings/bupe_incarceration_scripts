...
tab recentincar_q3 anyrecentopioids_q3 if retention3q==1, row exact
tab recentincar_qu3 anyrecentopioids_qu3 if retention3q==1, row exact
tab recentincar_q4 anyrecentopioids_q4 if retention4q==1, row exact
tab recentincar_qu4 anyrecentopioids_qu4 if retention4q==1, row exact
...
*How criminal justice at baseline affects opioid abstinence

tab everincar_base abstinentopioids_q1, chi2 row
tab everincar_base abstinentopioids_q2, chi2 row
tab everincar_base abstinentopioids_q3, chi2 row
tab everincar_base abstinentopioids_q4, chi2 row

tab everincar_base abstinentopioids_qu1, chi2 row
tab everincar_base abstinentopioids_qu2, chi2 row
tab everincar_base abstinentopioids_qu3, chi2 row
tab everincar_base abstinentopioids_qu4, chi2 row

tab recentincar_base abstinentopioids_q1, chi2 row
tab recentincar_base abstinentopioids_q2, chi2 row
tab recentincar_base abstinentopioids_q3, chi2 row
tab recentincar_base abstinentopioids_q4, chi2 row

tab recentincar_base abstinentopioids_qu1, chi2 row
tab recentincar_base abstinentopioids_qu2, chi2 row
tab recentincar_base abstinentopioids_qu3, chi2 row
tab recentincar_base abstinentopioids_qu4, chi2 row

tab parole_base abstinentopioids_q1, chi2 row
tab parole_base abstinentopioids_q2, chi2 row
tab parole_base abstinentopioids_q3, chi2 row
tab parole_base abstinentopioids_q4, chi2 row

tab parole_base abstinentopioids_qu1, chi2 row
tab parole_base abstinentopioids_qu2, chi2 row
tab parole_base abstinentopioids_qu3, chi2 row
tab parole_base abstinentopioids_qu4, chi2 row

*How criminal justice at baseline affects retained opioid abstinence

tab everincar_base abstinentopioids_q1 if retention1q==1, chi2 row
tab everincar_base abstinentopioids_q2 if retention2q==1, chi2 row
tab everincar_base abstinentopioids_q3 if retention3q==1, chi2 row
tab everincar_base abstinentopioids_q4 if retention4q==1, chi2 row

tab everincar_base abstinentopioids_qu1 if retention1q==1, chi2 row
tab everincar_base abstinentopioids_qu2 if retention2q==1, chi2 row
tab everincar_base abstinentopioids_qu3 if retention3q==1, chi2 row
tab everincar_base abstinentopioids_qu4 if retention4q==1, chi2 row

tab recentincar_base abstinentopioids_q1 if retention1q==1, chi2 row
tab recentincar_base abstinentopioids_q2 if retention2q==1, chi2 row
tab recentincar_base abstinentopioids_q3 if retention3q==1, chi2 row
tab recentincar_base abstinentopioids_q4 if retention4q==1, chi2 row

tab recentincar_base abstinentopioids_qu1 if retention1q==1, chi2 row
tab recentincar_base abstinentopioids_qu2 if retention2q==1, chi2 row
tab recentincar_base abstinentopioids_qu3 if retention3q==1, chi2 row
tab recentincar_base abstinentopioids_qu4 if retention4q==1, chi2 row

tab parole_base abstinentopioids_q1 if retention1q==1, chi2 row
tab parole_base abstinentopioids_q2 if retention2q==1, chi2 row
tab parole_base abstinentopioids_q3 if retention3q==1, chi2 row
tab parole_base abstinentopioids_q4 if retention4q==1, chi2 row

tab parole_base abstinentopioids_qu1 if retention1q==1, chi2 row
tab parole_base abstinentopioids_qu2 if retention2q==1, chi2 row
tab parole_base abstinentopioids_qu3 if retention3q==1, chi2 row
tab parole_base abstinentopioids_qu4 if retention4q==1, chi2 row
