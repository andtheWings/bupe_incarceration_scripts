...
***follow-up visits incarceration
gen q1_jail =  qc17_1
recode q1_jail 1/max = 1
gen q2_jail =  qc17_2
recode q2_jail 1/max = 1
gen q3_jail =  qc17_3
recode q3_jail 1/max = 1
gen q4_jail =  qc17_4
recode q4_jail 1/max = 1

tab q1_jail if dtxq1==1
tab q1_jail if dtxq1 != 1
tab q2_jail if dtxq2==1
tab q2_jail if dtxq2 != 1
tab q3_jail if dtxq3==1
tab q3_jail if dtxq3 != 1
tab q4_jail if dtxq4==1
tab q4_jail if dtxq4 != 1

gen notret1 = dtxq1
recode notret1 1 = 0 2/max = 1
gen notret2 = dtxq2
recode notret2 1 = 0 2/max = 1
gen notret3 = dtxq3
recode notret3 1 = 0 2/max = 1
gen notret4 = dtxq4
recode notret4 1 = 0 2/max = 1

tabulate notret1 q1_jail, chi2 exact row
tabulate notret2 q2_jail, chi2 exact row
tabulate notret3 q3_jail, chi2 exact row
tabulate notret4 q4_jail, chi2 exact row
