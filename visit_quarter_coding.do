...
replace first_followup_quarter = 2 if first_mnths_since==4 & second_mnths_since>7
...
replace first_followup_quarter = 3 if first_mnths_since==10 & first_mnths_since<second_mnths_since & second_mnths_since<13
replace first_followup_quarter = 4 if first_mnths_since==10 & second_mnths_since>first_mnths_since & second_mnths_since>9

replace second_followup_quarter = 1 if second_mnths_since<4 & first_mnths_since==.
...
replace second_followup_quarter = 2 if second_mnths_since==7 & second_mnths_since<third_mnths_since & third_mnths_since<10
...
replace third_followup_quarter = 3 if third_mnths_since==7 & second_mnths_since<third_mnths_since
replace third_followup_quarter = 3 if third_mnths_since>7 & third_mnths_since<10
replace third_followup_quarter = 3 if third_mnths_since==10 & third_mnths_since<fourth_mnths_since & fourth_mnths_since<13
...
replace third_followup_quarter = 4 if third_mnths_since>10 & third_mnths_since<13
...
replace fourth_followup_quarter = 3 if fourth_mnths_since>6 & fourth_mnths_since<10 & third_mnths_since==.
